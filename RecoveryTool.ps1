...
# The path to the folder where Sitecore XP0 webroot folder is located.
$SitecoreInstallationPath="c:\inetpub\wwwroot\$SitecoreSiteName"
# The path to the folder where XConnect application root is located.
$XConnectInstallationPath="c:\inetpub\wwwroot\$XConnectSiteName"
# The path to the folder where Sitecore Identity server root is located.
$IdentityInstallationPath="c:\inetpub\wwwroot\$IdentityServerSiteName"
...
$singleDeveloperParams = @{
    Path = ".\RecoveryTool.json"
    Prefix = $Prefix
    XConnectCertificateName = $XConnectSiteName
    IdentityServerCertificateName = $IdentityServerSiteName
    SitecoreSiteCertificateName = $SitecoreSiteName
    IdentityServerSiteName = $IdentityServerSiteName
    XConnectSiteName = $XConnectSiteName
    SitecoreSitename = $SitecoreSiteName
    ClientSecret = $ClientSecret
    SitecoreInstallationPath = $SitecoreInstallationPath
    XConnectInstallationPath = $XConnectInstallationPath
    IdentityInstallationPath = $IdentityInstallationPath
	SolrUrl = $SolrUrl
	SolrRoot = $SolrRoot
	SolrService = $SolrService
}

$intallationChoices = '&Install', '&Uninstall'
            $intallationChoice = $Host.UI.PromptForChoice("Are you going to Install or temporary Uninstall Sitecore sites?", "Choose the option, please:", $intallationChoices, 0)
if($intallationChoice -eq 1){

	# Uncomment the below line and comment out the above if you want to remove the XP0 SingleDeveloper Config
	Uninstall-SitecoreConfiguration @singleDeveloperParams *>&1 | Tee-Object Recovery-Uninstall.log
	
}else{
	Install-SitecoreConfiguration @singleDeveloperParams *>&1 | Tee-Object Recovery.log	
}
